  ...
  return (
    <div className=" font-mont">
      ...
      <div className="px-4 flex flex-col w-full lg:px-24 lg:flex-row justify-between">
        <div className="mt-16 px-4 lg:px-0 lg:py-14 lg:mt-0">
          <ul className="text-lg mt-5 lg:mt-0 lg:text-2xl flex flex-col justify-around h-full text-sky-theme lg:font-medium list-disc">
            <li>No appointment, no waiting,</li>
            <li>Instant consultation & guidance,</li>
            <li>Civil & criminal legal consultation are available,</li>
            <li>Absolute clear guidance in legal carrer path,</li>
            <li>Any query are sought out with ease,</li>
            <li>Guidance about all legal pillar</li>
          </ul>
        </div>
        <div>
          <img
      ...
      <img
        ...
        alt="service page"
        className="visible absolute bottom-0 left-0 lg:invisible"
      />
    </div>
  );
};
