...
const HomeFooter = () => {
  return (
    <div className=" h-[50rem] px-4 py-8 pb-16 bg-footer-bg text-white lg:h-auto lg:px-24 lg:py-12 flex-col">
      <div className="flex flex-col justify-between lg:flex-row">
        ...
        <div className="text-center py-4 my-5 border-b-[1px] border-dashed lg:text-left lg:border-none lg:py-0 lg:my-0">
